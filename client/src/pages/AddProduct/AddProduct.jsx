...
function AddProduct({ }) {
    ...
    const handleSubmit = async () => {
        ...
        if (!formData.productId || !formData.name || !formData.categoryId || !formData.classId || !formData.retailerId) {
            Toast.fire({
                icon: "error",
            ...
            <div className="flex flex-1 flex-col gap-[34px] items-center justify-start md:mt-0 mt-[59px] w-full py-8">
                ...
                <div className="flex flex-col gap-4 items-center justify-start w-full">
                    ...
                    <div className="flex flex-col items-center justify-start w-full">
                        ...
                        <Variants
                            name='variation'
                            value={formData.variation} set={formData.set} stream={formData.stream} onChange={handleChange}
                            className="font-medium md:h-auto p-0 placeholder:text-blue_gray-300 sm:h-auto text-base text-left w-full"
                            wrapClassName="border border-blue_gray-100 border-solid mt-1 rounded-lg w-full"
                        />
                    </div>
...
const Variants = ({ name, set, stream, wrapClassName, onChange = () => { } }, ...props) => {
                            ...
                            <div key={streamIndex}>
                                ...
                                <div className='flex items-center gap-3'>
                                    <Input
                                        ...
                                        onChange={(e) => handlePriceChange(setIndex, streamIndex, e)}
                                    />
                                    <Input
                                        name="salePrice"
